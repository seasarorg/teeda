 ...
 *
 */
public class THtmlCommandButtonRendererTest extends TeedaTestCase {

    public void testEncodeEnd() throws Exception {
        UIForm form = new UIForm();
        THtmlCommandButton component = new THtmlCommandButton();
        component.setId("doOnceSubmit");
        ...
        assertNotNull(hiddenParams.get(TransactionTokenUtil.TOKEN));
    }
}