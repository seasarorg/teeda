...
import org.seasar.teeda.extension.mock.MockTHtmlSelectManyListbox;

/**
 * @author manhole
 */
public class THtmlSelectManyListboxRendererTest extends RendererTest {

    private THtmlSelectManyListboxRenderer renderer;

    private MockTHtmlSelectManyListbox htmlSelectManyListbox;

    protected void setUp() throws Exception {
        super.setUp();
        renderer = createTHtmlSelectManyListboxRenderer();
        htmlSelectManyListbox = new MockTHtmlSelectManyListbox();
    ...
    public void testEncode_Checked() throws Exception {
        // ## Arrange ##
        htmlSelectManyListbox.setSelectedValues(new String[] { "val" });
        {
            UISelectItem selectItem = new UISelectItem();
            selectItem.setItemValue("val");
            selectItem.setItemLabel("lab");
        ...
        // ## Assert ##
        assertEquals("<select name=\"_id0\" multiple=\"multiple\" size=\"2\">"
                + "<option value=\"val\" selected=\"selected\">lab</option>"
                + "<option value=\"v2\">l2</option></select>",
                getResponseText());
    }

    public void testEncode_CheckedAndChecked() throws Exception {
        // ## Arrange ##
        htmlSelectManyListbox.setSelectedValues(new String[] { "val" });
        htmlSelectManyListbox.setDisabled(true);
        {
    ...
    private THtmlSelectManyListboxRenderer createTHtmlSelectManyListboxRenderer() {
        return (THtmlSelectManyListboxRenderer) createRenderer();
    }

    protected Renderer createRenderer() {
        THtmlSelectManyListboxRenderer renderer = new THtmlSelectManyListboxRenderer();
