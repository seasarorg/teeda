 ...
 * @author koichik
 */
public class TUploadedFileFileConverterTest extends
        AbstractUploadedFileConverterTest {

    protected AbstractUploadedFileConverter getConverter() {
        return new TUploadedFileFileConverter();
    }
    ...
    public void testGetAsObject() throws Exception {
        TUploadedFileFileConverter converter = new TUploadedFileFileConverter();
        ...
        File file = (File) converter.getAsObject(getFacesContext(), inputFile,
                "");
        assertEquals(new File("aaa"), file);
    }
