...
import org.seasar.teeda.extension.mock.MockTHtmlSelectManyCheckbox;

/**
 * @author manhole
 */
public class THtmlSelectManyCheckboxRendererTest extends RendererTest {

    private THtmlSelectManyCheckboxRenderer renderer;

    private MockTHtmlSelectManyCheckbox htmlSelectManyCheckbox;

    protected void setUp() throws Exception {
        super.setUp();
        renderer = createTHtmlSelectManyCheckboxRenderer();
    ...
    public void testEncode_Child_col0() throws Exception {
        // ## Arrange ##
        {
            for (int i = 0; i < 4; ++i) {
                UISelectItem selectItem = new UISelectItem();
                selectItem.setItemValue("val" + i);
                selectItem.setItemLabel("lab" + i);
                htmlSelectManyCheckbox.getChildren().add(selectItem);
            }
            htmlSelectManyCheckbox.setCol(new Integer(0));
        }
        ...
        assertEquals(
                "<table>"
                        + "<tr>"
                        + "<td><label><input type=\"checkbox\" name=\"_id0\" value=\"val0\" />lab0</label></td>"
                        + "<td><label><input type=\"checkbox\" name=\"_id0\" value=\"val1\" />lab1</label></td>"
                        + "<td><label><input type=\"checkbox\" name=\"_id0\" value=\"val2\" />lab2</label></td>"
                        + "<td><label><input type=\"checkbox\" name=\"_id0\" value=\"val3\" />lab3</label></td>"
                        + "</tr>" + "</table>", getResponseText());
    }

    public void testEncode_Child_col1() throws Exception {
        // ## Arrange ##
        {
            for (int i = 0; i < 4; ++i) {
                UISelectItem selectItem = new UISelectItem();
            ...
            htmlSelectManyCheckbox.setCol(new Integer(1));
        }
    ...
    public void testEncode_Child_col2() throws Exception {
        // ## Arrange ##
        {
            for (int i = 0; i < 4; ++i) {
                UISelectItem selectItem = new UISelectItem();
            ...
            htmlSelectManyCheckbox.setCol(new Integer(2));
        }
    ...
    public void testEncode_Child_col3() throws Exception {
        // ## Arrange ##
        {
            for (int i = 0; i < 4; ++i) {
                UISelectItem selectItem = new UISelectItem();
            ...
            htmlSelectManyCheckbox.setCol(new Integer(3));
        }
    ...
    public void testEncode_Child_col4() throws Exception {
        // ## Arrange ##
        {
            for (int i = 0; i < 4; ++i) {
                UISelectItem selectItem = new UISelectItem();
            ...
            htmlSelectManyCheckbox.setCol(new Integer(4));
        }
    ...
    public void testEncode_Child_col5() throws Exception {
        // ## Arrange ##
        {
            for (int i = 0; i < 4; ++i) {
                UISelectItem selectItem = new UISelectItem();
            ...
            htmlSelectManyCheckbox.setCol(new Integer(5));
        }
    ...
    private THtmlSelectManyCheckboxRenderer createTHtmlSelectManyCheckboxRenderer() {
        return (THtmlSelectManyCheckboxRenderer) createRenderer();
    }

    protected Renderer createRenderer() {
        THtmlSelectManyCheckboxRenderer renderer = new THtmlSelectManyCheckboxRenderer();
