...
import org.seasar.teeda.extension.taglib.TTreeHiddenTag;

/**
 * @author shot
 */
public class TreeHiddenFactoryTest extends ElementProcessorFactoryTestCase {

    protected AbstractElementProcessorFactory createFactory() {
        return new TreeHiddenFactory();
    }

    protected void registerTagElements() {
        registerTagElement(ExtensionConstants.TEEDA_EXTENSION_URI,
                "treeHidden", TTreeHiddenTag.class);
    }

    public void testIsMatch() throws Exception {
        Map map = new HashMap();
        map.put("type", "hidden");
        map.put("id", "ttttTreeSave");
    ...
    public void testCreateProcessor() throws Exception {
        ...
        properties.put("id", "ttttTreeSave");
        ...
        assertEquals("2", TTreeHiddenTag.class, parentProcessor.getTagClass());
        assertEquals("3", "#{fooPage.tttt}", parentProcessor
                .getProperty("value"));
    }
