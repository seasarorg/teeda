...
import org.seasar.teeda.extension.taglib.TSessionSaveTag;

/**
 * @author shot
 */
public class TSessionSaveFactoryTest extends ElementProcessorFactoryTestCase {

    protected AbstractElementProcessorFactory createFactory() {
        return new SessionSaveFactory();
    }

    protected void registerTagElements() {
        registerTagElement(ExtensionConstants.TEEDA_EXTENSION_URI,
                "sessionSave", TSessionSaveTag.class);
    }

    public void testIsMatch() throws Exception {
        Map map = new HashMap();
        map.put("type", "hidden");
        map.put("id", "hogeItemsSessionSave");
    ...
    public void testCreateProcessor() throws Exception {
        ...
        properties.put("id", "hogeItemsSessionSave");
        ...
        assertEquals(TSessionSaveTag.class, parentProcessor.getTagClass());
        assertEquals("#{fooPage.hogeItems}", parentProcessor
                .getProperty("value"));
    }
}