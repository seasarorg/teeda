 ...
 * @author shot
 */
public class THtmlInfoMessagesRendererTest extends AbstractRendererTest {

    private THtmlInfoMessagesRenderer renderer;
    ...
    public void testEncode_InfoOnly() throws Exception {
        FacesContext context = getFacesContext();
        {
            FacesMessage facesMessage = new FacesMessage();
            facesMessage.setSummary("s1");
        ...
        }
        {
            ...
            context.addMessage("bbb", facesMessage);
        }
        {
            FacesMessage facesMessage = new FacesMessage();
            facesMessage.setSummary("s4");
            facesMessage.setSeverity(FacesMessage.SEVERITY_FATAL);
            context.addMessage("ccc", facesMessage);
        }
        ...
        // ## Assert ##
        assertEquals("<ul><li>s1</li></ul>", getResponseText());

    }

    private THtmlInfoMessagesRenderer createHtmlMessagesRenderer() {
        return (THtmlInfoMessagesRenderer) createRenderer();
    }

    protected Renderer createRenderer() {
        THtmlInfoMessagesRenderer renderer = new THtmlInfoMessagesRenderer();
