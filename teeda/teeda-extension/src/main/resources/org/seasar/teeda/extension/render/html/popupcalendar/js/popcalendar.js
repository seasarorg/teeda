...
function jscalendarConstructCalendar () {
	...
	for	( datePointer=1; datePointer<=numDaysInMonth; datePointer++ ){
		...
		sHTML += "<a class='excludeDisabled "+sStyle+"' "+dateMessage+" title=\"" + sHint + "\" href='javascript:jscalendarDateSelected="+datePointer+";jscalendarCloseCalendar();' onmouseover='this.className=\""+sSelectStyle+"\";' >&#160;" + datePointer + "&#160;</a>";
