 ...
 * @author shot
 */
public class TLessValidator extends AbstractCompareValidator {

    public static final String LR_MESSAGE_ID = "org.seasar.teeda.extension.validator.TLessValidator.LR";
