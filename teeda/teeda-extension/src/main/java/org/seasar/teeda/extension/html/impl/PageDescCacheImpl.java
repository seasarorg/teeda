...
public class PageDescCacheImpl implements PageDescCache {
    ...
    private PageAutoNaming pageAutoNaming = new DefaultPageAutoNaming();
    ...
    public void setPageAutoNaming(PageAutoNaming pageAutoNaming) {
        this.pageAutoNaming = pageAutoNaming;
    }
    ...
    public synchronized PageDesc createPageDesc(String viewId) {
        ...
        String pageName = pageAutoNaming.convertToPageName(viewId);
