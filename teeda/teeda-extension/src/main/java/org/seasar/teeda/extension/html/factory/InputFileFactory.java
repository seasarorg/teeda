 ...
 * @author koichik
 */
public class InputFileFactory extends AbstractElementProcessorFactory {

    private static final String TAG_NAME = "inputFile";
    ...
    public boolean isMatch(ElementNode elementNode, PageDesc pageDesc,
        ...
        if (property != null &&
                !JsfConstants.FILE_VALUE.equalsIgnoreCase(property)) {
            return false;
        }
        if (pageDesc == null) {
            return false;
