...
public class ValidatorAnnotationHandlerFactory {
    ...
    private static final String BACKPORT175_ANNOTATION_HANDLER_CLASS_NAME = "org.seasar.teeda.extension.annotation.handler.Backport175ValidatorAnnotationHandler";
