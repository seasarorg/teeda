...
public class HtmlMessage extends UIMessage {
    ...
    public Object saveState(FacesContext context) {
        ...
        values[6] = infoStyle_;
        values[7] = style_;
        values[8] = styleClass_;
        values[9] = title_;
        values[10] = tooltip_;
        values[11] = warnClass_;
        values[12] = warnStyle_;
    ...
    public void restoreState(FacesContext context, Object state) {
        ...
        style_ = (String) values[7];
        styleClass_ = (String) values[8];
        title_ = (String) values[9];
        tooltip_ = (Boolean) values[10];
        warnClass_ = (String) values[11];
        warnStyle_ = (String) values[12];
    }
}
