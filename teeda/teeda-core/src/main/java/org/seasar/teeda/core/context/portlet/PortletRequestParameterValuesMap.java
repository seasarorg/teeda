...
/**
 * PortletRequestParameterValuesMap is RequestParameterValuesMap implementation for Portlet environment.
 * 
 * @author shinsuke
 * 
 */
public class PortletRequestParameterValuesMap extends
    ...
    PortletRequestParameterValuesMap(PortletRequest portletRequest) {
        portletRequest_ = portletRequest;
    }

    protected Object getAttribute(String key) {
        return portletRequest_.getParameterValues(key);
    }
