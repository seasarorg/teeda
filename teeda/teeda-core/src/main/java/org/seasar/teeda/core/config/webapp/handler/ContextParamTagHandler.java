...
import org.seasar.teeda.core.config.webapp.element.impl.ContextParamElementImpl;
import org.xml.sax.Attributes;

/**
 * @author manhole
 */
public class ContextParamTagHandler extends TagHandler {
    ...
    public void end(TagHandlerContext context, String body) {
        ContextParamElement contextParam = (ContextParamElement) context.pop();
