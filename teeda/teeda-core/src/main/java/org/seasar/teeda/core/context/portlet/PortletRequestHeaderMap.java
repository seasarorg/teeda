...
/**
 * PortletRequestHeaderMap is RequestHeaderMap implementation for Portlet environment.
 * 
 * @author shinsuke
 * 
 */
public class PortletRequestHeaderMap extends AbstractUnmodifiableExternalContextMap {
    ...
    PortletRequestHeaderMap(PortletRequest portletRequest) {
        portletRequest_ = portletRequest;
    }

    protected Object getAttribute(String key) {
        return portletRequest_.getProperty(key);
    }
