...
import org.seasar.teeda.core.config.webapp.element.impl.FilterElementImpl;
...
public class FilterTagHandler extends TagHandler {
    ...
    public void start(TagHandlerContext context, Attributes attributes) {
        context.push(createFilterElement());
    }

    public void end(TagHandlerContext context, String body) {
        FilterElement servlet = (FilterElement) context.pop();
        WebappConfig webappConfig = (WebappConfig) context.peek();
        webappConfig.addFilterElement(servlet);
    }

    protected FilterElement createFilterElement() {
