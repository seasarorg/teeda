...
public class DIContainerUtil {
    ...
    public static void registerComponent(String name, Class type, Scope scope) {
        ...
        ScopeTranslator translator = (ScopeTranslator) container
                .getComponent(ScopeTranslator.class);
        InstanceDef instanceDef = (InstanceDef) translator
                .toExternalComponentScope(scope);
