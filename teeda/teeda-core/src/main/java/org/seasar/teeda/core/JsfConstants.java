...
public interface JsfConstants {
    ...
    String[] JSF_IMPLICIT_OBJECTS = { APPLICATION_SCOPE, COOKIE,
    ...
    String[] ANCHOR_ATTRIBUTES = { ACCESSKEY_ATTR, CHARSET_ATTR,
    ...
    String[] ANCHOR_PASSTHROUGH_ATTRIBUTES = (String[]) ArrayUtil.add(
    ...
    String[] COMMON_FIELD_EVENT_ATTRIBUTES = { ONFOCUS_ATTR,
            ONBLUR_ATTR, ONSELECT_ATTR, ONCHANGE_ATTR };

    String[] LABEL_ATTRIBUTES = { ACCESSKEY_ATTR, ONBLUR_ATTR,
    ...
    String[] ID_WITH_COMMON_PASSTROUGH_ATTRIBUTES = (String[]) ArrayUtil
    ...
    String[] TEXTAREA_ATTRIBUTES = { COLS_ATTR, DATAFLD_ATTR,
    ...
    String[] IMG_ATTRIBUTES = { ALIGN_ATTR, ALT_ATTR, BORDER_ATTR,
    ...
    String[] FORM_ATTRIBUTES = { ACCEPT_ATTR, ACCEPTCHARSET_ATTR,
    ...
    String[] SELECT_TABLE_PASSTHROUGH_ATTRIBUTES = new String[] {
