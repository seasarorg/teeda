...
public class CommonsExpressionProcessorImpl implements ExpressionProcessor{
    ...
    public void init(){
        ...
        replacers_.put(BinaryOperatorExpression.class, new BinaryOperatorExpressionReplacer(this));
        replacers_.put(UnaryOperatorExpression.class, new UnaryOperatorExpressionReplacer(this));
        replacers_.put(FunctionInvocation.class, new IgnorerableExpressionReplacer(this));
        replacers_.put(Literal.class, new IgnorerableExpressionReplacer(this));
        replacers_.put(NamedValue.class, new IgnorerableExpressionReplacer(this));
        replacers_.put(ExpressionString.class, new ExpressionStringReplacer(this));
    ...
    public Object evaluate(FacesContext context, Object expression) 
        ...
        try{
            ...
            if(expression instanceof Expression){
                return ((Expression)expression).evaluate(resolver, mapper_, CommonsElLogger.getLogger());
            }else if(expression instanceof ExpressionString){
                return ((ExpressionString)expression).evaluate(resolver, mapper_, CommonsElLogger.getLogger());
            }
        }catch(ELException e){
    ...
    public Object resolveBase(FacesContext context, Object expression) 
        ...
        while (expression instanceof ConditionalExpression){
            ...
            expression = (condition) ? 
                    conditionalExpression.getTrueBranch() : conditionalExpression.getFalseBranch();
        }
    ...
    public Object getCoercedObject(Object newValue, Class type) throws EvaluationException{
