...
public class MethodBindingImpl extends MethodBinding implements StateHolder{
	...
	public Object invoke(FacesContext context, Object[] params)
        ...
        try {
			...
			throw new ExtendEvaluationException(e,
					base.getClass().getName(), getExpressionString());
		}
	}
	...
	public Class getType(FacesContext context) throws MethodNotFoundException {
        ...
        Class returnType;
		try {
			returnType = base.getClass().getMethod(property.toString(), classes_).getReturnType();
	...
	private Object[] getBaseAndProperty(FacesContext context) throws ReferenceSyntaxException{
		...
		Object o = parser_.getExpressionProcessor().resolveBase(context, expression);
