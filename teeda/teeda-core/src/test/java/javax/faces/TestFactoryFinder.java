 ...
 */
public class TestFactoryFinder extends TestCase {

	public static TestSuite suite() {
		TestSuite suite = new TestSuite();
		suite.addTest(new TestFactoryFinder("testApplicationFactory"));
		suite.addTest(new TestFactoryFinder("testFacesContextFactory"));
		suite.addTest(new TestFactoryFinder("testLifecycleFactory"));
		suite.addTest(new TestFactoryFinder("testRenderKitFactory"));
		suite.addTest(new TestFactoryFinder("testGetFactory"));
        suite.addTest(new TestFactoryFinder("testDuplicateSetFactory"));
        suite.addTest(new TestFactoryFinder("testNotFactoryNameGiven"));
        suite.addTest(new TestFactoryFinder("testNotSetFactory"));
        suite.addTest(new TestFactoryFinder("testSetUnidentifyFatoryName"));
		return suite;
	}

	public static void main(String[] args) {
		junit.textui.TestRunner.run(TestFactoryFinder.class);
	}
	...
	/**
	 * Constructor for TestFactoryFinder.
	 * 
	 * @param arg0
	 */
	public TestFactoryFinder(String name) {
		super(name);
	}
