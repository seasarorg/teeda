 ...
 * @author manhole
 */
public class HtmlSelectBooleanCheckboxOnlyTest extends TestCase {
    ...
    public void testGetComponentFamily() {
        ...
        assertEquals("javax.faces.SelectBoolean", htmlSelectBooleanCheckbox
                .getFamily());
    }

    public void testDefaultRendererType() throws Exception {
        HtmlSelectBooleanCheckbox htmlSelectBooleanCheckbox = new HtmlSelectBooleanCheckbox();
        assertEquals("javax.faces.Checkbox", htmlSelectBooleanCheckbox
                .getRendererType());
    }
