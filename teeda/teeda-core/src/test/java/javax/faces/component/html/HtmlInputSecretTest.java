...
public class HtmlInputSecretTest extends UIInputTest {
    ...
    public void testSetGetMaxlength_ValueBinding() throws Exception {
        ...
        assertEquals(new Integer(111), component.getValueBinding("maxlength")
                .getValue(context));
    }
    ...
    public void testSetGetRedisplay() throws Exception {
        HtmlInputSecret component = createHtmlInputSecret();
        assertEquals(false, component.isRedisplay());
        component.setRedisplay(true);
        assertEquals(true, component.isRedisplay());
    }
    ...
    public void testSetGetRedisplay_ValueBinding() throws Exception {
        ...
        FacesContext context = getFacesContext();
        vb.setValue(context, Boolean.TRUE);
        component.setValueBinding("redisplay", vb);
        assertEquals(true, component.isRedisplay());
        assertEquals(Boolean.TRUE, component.getValueBinding("redisplay")
                .getValue(context));
    }
    ...
    public void testSetGetSize_ValueBinding() throws Exception {
        ...
        assertEquals(new Integer(111), component.getValueBinding("size")
                .getValue(context));
    }
