...
import org.seasar.framework.aop.javassist.ClassLoaderUtil;
...
public class RuntimeClassUtil {
    ...
    public static Object defineClass(final Class targetClass,
        ...
        try {
            final Object o = defineClassMethod.invoke(ClassLoaderUtil
    ...
    static Object createInstance(final Class targetClass) {
        ...
        try {
            ...
            final CtClass ifs = cp.get(RuntimeClass.class
                    .getName());
            ...
            Aspect aspect = new AspectImpl(
                    new RuntimeClassInterceptor(), pointcut);
