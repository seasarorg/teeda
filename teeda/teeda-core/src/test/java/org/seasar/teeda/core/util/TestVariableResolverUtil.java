...
public class TestVariableResolverUtil extends TeedaTestCase {

	public static void main(String[] args) {
		junit.textui.TestRunner.run(TestVariableResolverUtil.class);
	}

	public TestVariableResolverUtil(String arg0) {
		super(arg0);
	}
	...
	public void testResolveVariable(){
		...
		Object value = VariableResolverUtil.resolveVariable(getFacesContext(), "hoge");
	...
	public void testGetDefaultScopeMap(){
		...
		Object value = VariableResolverUtil.getDefaultScopeMap(getFacesContext(), resolver, "key");
		assertNotNull(value);
		...
		value = VariableResolverUtil.getDefaultScopeMap(getFacesContext(), resolver, "key2");
		assertNotNull(value);
		...
		value = VariableResolverUtil.getDefaultScopeMap(getFacesContext(), resolver, "key3");
		assertNotNull(value);
