...
public class NoValueReferenceRuntimeExceptionTest extends TestCase {
    ...
    public void testGetMessage() throws Exception {
        NoValueReferenceRuntimeException ex = new NoValueReferenceRuntimeException(
                "hoge");
        StringAssert.assertContains("ETDA0020", ex.getMessage());
    }

    public void testGetComponentClass() throws Exception {
        NoValueReferenceRuntimeException ex = new NoValueReferenceRuntimeException(
                "foo");
        assertEquals("foo", ex.getExpression());
    }
